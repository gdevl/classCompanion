...
export default function UserCard({ props }) {
  ...
  return (
    <>
      <Card
        key={user.id}
        className={checkedIn(user.id) ? classes.checkedIn : classes.checkedOut}
      >
        <CardHeader
          avatar={
            <Avatar
          ...
          action={
            <IconButton
              ...
              className={
                hasQuestion(user.id) ? classes.handIcon : classes.hidden
              }
            >
              <PanToolIcon />
            </IconButton>
        ...
        <CardActions disableSpacing className={classes.cardActionsContainer}>
          ...
          <IconButton
            className={[
              clsx(classes.expand, {
                [classes.expandOpen]: expanded == user.id,
              }),
              hasQuestion(user.id) ? "" : classes.hidden,
            ]}
